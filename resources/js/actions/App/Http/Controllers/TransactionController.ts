 ...
 * @see app/Http/Controllers/TransactionController.php:97
 * @route '/transactions'
 */
 ...
 * @see app/Http/Controllers/TransactionController.php:336
 ...
 * @see app/Http/Controllers/TransactionController.php:347
 ...
 * @see app/Http/Controllers/TransactionController.php:355
 * @route '/transactions/{transaction}'
 */
 ...
 * @see app/Http/Controllers/TransactionController.php:363
 * @route '/transactions/{transaction}'
 */
...
/**
* @see \App\Http\Controllers\TransactionController::returnItems
 * @see app/Http/Controllers/TransactionController.php:261
 * @route '/transactions/{transaction}/return'
 */
export const returnItems = (args: { transaction: number | { id: number } } | [transaction: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
returnItems.definition = {
    methods: ["post"],
    url: '/transactions/{transaction}/return',
} satisfies RouteDefinition<["post"]>
 ...
 * @route '/transactions/{transaction}/return'
 */
returnItems.url = (args: { transaction: number | { id: number } } | [transaction: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { transaction: args }
    }
 ...
 * @route '/transactions/{transaction}/return'
 */
returnItems.post = (args: { transaction: number | { id: number } } | [transaction: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: returnItems.url(args, options),
    method: 'post',
})
 ...
 * @route '/transactions/{transaction}/return'
 */
    const returnItemsForm = (args: { transaction: number | { id: number } } | [transaction: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: returnItems.url(args, options),
        method: 'post',
    })
 ...
 * @route '/transactions/{transaction}/return'
 */
        returnItemsForm.post = (args: { transaction: number | { id: number } } | [transaction: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: returnItems.url(args, options),
            method: 'post',
        })
...
/**
* @see \App\Http\Controllers\TransactionController::confirm
 * @see app/Http/Controllers/TransactionController.php:319
 * @route '/transactions/{transaction}/confirm'
 */
export const confirm = (args: { transaction: number | { id: number } } | [transaction: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
confirm.definition = {
    methods: ["post"],
    url: '/transactions/{transaction}/confirm',
} satisfies RouteDefinition<["post"]>
 ...
 * @route '/transactions/{transaction}/confirm'
 */
confirm.url = (args: { transaction: number | { id: number } } | [transaction: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { transaction: args }
    }
 ...
 * @route '/transactions/{transaction}/confirm'
 */
confirm.post = (args: { transaction: number | { id: number } } | [transaction: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: confirm.url(args, options),
    method: 'post',
})
 ...
 * @route '/transactions/{transaction}/confirm'
 */
    const confirmForm = (args: { transaction: number | { id: number } } | [transaction: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/transactions/{transaction}/confirm'
 */
        confirmForm.post = (args: { transaction: number | { id: number } } | [transaction: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: confirm.url(args, options),
            method: 'post',
        })
    
    confirm.form = confirmForm
const TransactionController = { index, create, store, show, edit, update, destroy, returnItems, confirm }
