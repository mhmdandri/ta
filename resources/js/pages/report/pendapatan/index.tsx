    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-4">
                ...
                {/* Filters */}
                <Card className="mb-6 border-slate-200 bg-gradient-to-r from-slate-50 to-slate-100">
                    <CardHeader className="pb-3">
                        <CardTitle className="flex items-center gap-2 text-base text-slate-700">
                            <Filter className="h-5 w-5 text-blue-500" /> Filter Laporan
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-6">
                            ...
                            <div className="flex items-end justify-end md:col-span-2">
                                <Button className="w-full bg-blue-600 transition-colors hover:bg-blue-700 md:w-auto" onClick={applyFilter}>
                                    Terapkan Filter
                                </Button>
                            </div>
                        </div>
                ...
                <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card className="overflow-hidden border-green-100 bg-gradient-to-br from-green-50 to-white">
                        <CardHeader className="pb-2">
                            <CardTitle className="flex items-center text-sm font-medium text-slate-600">
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-green-700">{formatIDR(summary?.total_net_net ?? 0)}</div>
                                    ...
                                    <TableBody>
                                        ...
                                        {rows.map((r) => (
                                            <TableRow
                                                ...
                                                className={`transition-colors hover:cursor-pointer hover:bg-slate-50 ${r.is_daily_split ? 'border-l-4 border-l-blue-500 bg-blue-50' : ''}`}
                                            >
                                                <TableCell className="font-medium">
                                                    {formatDateID(r.date)}
                                                    {r.is_daily_split && <div className="mt-1 text-xs text-blue-600">harian</div>}
                                                ...
                                                <TableCell className="text-right font-medium">
                                                    {formatIDR(r.total_net)}
                                                    {/* {r.is_daily_split && (
                                                        <div className="mt-1 text-xs text-blue-600">1/{r.rental_duration} bagian</div>
                                                    )} */}
                                                </TableCell>
                                                <TableCell className="text-right font-medium text-green-600">
                                                    {formatIDR(r.total_net_net)}
