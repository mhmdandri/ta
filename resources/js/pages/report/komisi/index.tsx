...
import { formatKomisi, formatRupiah } from '@/lib/formatRupiah';
...
import KomisiManagerTable from './components/KomisiManagerTable';
import KomisiSpvTable from './components/KomisiSpvTable';
...
const Index = () => {
    const { sales, filters, spv, manager, total_target, total_pencapaian, total_persen } = usePage<PageProps>().props;
    ...
    console.log('list spv', spv);
    console.log('list sales', sales);
        ...
        <div className="min-h-screen bg-[#F7F7F7]">
            <AppLayout breadcrumbs={breadcrumbs}>
                ...
                <div className="space-y-6 p-4 md:p-6">
                    ...
                    {/* Filter */}
                    <Card className="border-[#E7E7E7] bg-primary-foreground shadow-sm">
                            ...
                            <CardContent className="p-4">
                                <div className="flex items-start justify-between">
                                    <div>
                                        ...
                                        <h3 className="mt-1 text-2xl font-bold">{formatRupiah(total_target, false)}</h3>
                                    </div>
                            ...
                            <CardContent className="p-4">
                                <div className="flex items-start justify-between">
                                    <div>
                                        ...
                                        <h3 className="mt-1 text-2xl font-bold">{formatRupiah(total_pencapaian, false)}</h3>
                                    </div>
                                    <div className="rounded-full">
                            ...
                            <CardContent className="p-4">
                                <div className="flex items-start justify-between">
                                    <div>
                                        ...
                                        <h3 className="text-brand-navy mt-1 text-2xl font-bold">{formatKomisi(total_persen)}</h3>
                                    </div>
                                    <div className="rounded-full">
                    ...
                    <Tabs defaultValue="sales" className="w-full">
                        <TabsList>
                            ...
                            <TabsTrigger value="spv">Spv</TabsTrigger>
                                            ...
                                            <div key={s.id} className="p-4 transition-colors hover:bg-[#FDFDFD]">
                                                <div className="flex cursor-pointer items-center justify-between" onClick={() => toggleExpand(s.id)}>
                                                    ...
                                                    <div className="flex items-center gap-4">
                                                        <div className="text-right">
                                                            ...
                                                            <p
                                                                className={`font-medium ${s.persenTarget >= 100 ? 'text-brand-navy' : 'text-brand-red'}`}
                                                            >
                                                                {formatKomisi(s.persenTarget)}
                                                            </p>
                                                        </div>
                                                ...
                                                {expandedSales.includes(s.id) && (
                                                    <>
                                                        ...
                                                        <div className="mt-4 grid grid-cols-1 gap-4 pl-11 md:grid-cols-2 lg:grid-cols-7">
                                                            ...
                                                            <div className="rounded-lg bg-primary-foreground p-3">
                                                                ...
                                                                <p className="text-sm font-semibold">
                                                                    {formatRupiah(s.sum_total_net_net_cabang, false)}
                                                                </p>
                                                            </div>
                                                            <div className="rounded-lg bg-primary-foreground p-3">
                                                                <p className="text-xs font-medium">Average Disc</p>
                                                                <p className="text-sm font-semibold">{formatKomisi(s.avgDisc)}</p>
                                                            </div>
                                                            <div className="rounded-lg bg-primary-foreground p-3">
                                                        ...
                                                        <KomisiSummaryTable s={s} formatRupiah={formatRupiah} formatKomisi={formatKomisi} />
                                                    </>
                                                )}
                                            </div>
                                        ))}
                                                ...
                                                {expandedSales.includes(s.id) && (
                                                    <>
                                                        ...
                                                        <div className="mt-4 grid grid-cols-1 gap-4 pl-11 md:grid-cols-2 lg:grid-cols-7">
                                                            <div className="rounded-lg bg-primary-foreground p-3">
                                                                <p className="text-brand-navy text-xs font-medium">Target Pencapaian</p>
                                                                <p className="text-sm font-semibold">{formatRupiah(s.target_spv, false)}</p>
                                                            </div>
                                                            <div className="rounded-lg bg-primary-foreground p-3">
                                                                <p className="text-xs font-medium">Pencapaian</p>
                                                                <p className="text-sm font-semibold">{formatRupiah(s.sum_total_net_net, false)}</p>
                                                        ...
                                                        <KomisiSpvTable s={s} formatRupiah={formatRupiah} formatKomisi={formatKomisi} />
                                                    </>
                                                )}
                                            </div>
                                        ))}
                        ...
                        <TabsContent value="manager">
                            <Card>
                                <CardHeader className="border-b bg-[#FAFAFA]">
                                    <CardTitle className="flex items-center gap-2">
                                        <BarChart3 className="text-brand-navy h-5 w-5" />
                                        <span>Detail Performa Manager</span>
                                    </CardTitle>
                                </CardHeader>
                                <CardContent className="p-0">
                                    <div className="divide-y divide-[#EFEFEF]">
                                                ...
                                                {expandedSales.includes(s.id) && (
                                                    <>
                                                        ...
                                                        <div className="mt-4 grid grid-cols-1 gap-4 pl-11 md:grid-cols-2 lg:grid-cols-7">
                                                            <div className="rounded-lg bg-primary-foreground p-3">
                                                                <p className="text-brand-navy text-xs font-medium">Target Pencapaian</p>
                                                                <p className="text-sm font-semibold">{formatRupiah(s.target_manager, false)}</p>
                                                            </div>
                                                            <div className="rounded-lg bg-primary-foreground p-3">
                                                                <p className="text-xs font-medium">Pencapaian</p>
                                                                <p className="text-sm font-semibold">{formatRupiah(s.sum_total_net_net, false)}</p>
                                                        ...
                                                        <KomisiManagerTable s={s} formatRupiah={formatRupiah} formatKomisi={formatKomisi} />
                                                    </>
                                                )}
                                            </div>
                                        ))}
