...
export default function KomisiSummaryTable({ s, formatRupiah, formatPercent }: Props) {
            ...
            <Table>
                ...
                <TableBody>
                    <TableRow>
                        ...
                        <TableCell className="text-right">{formatPercent(avgDisc)}</TableCell>
                        <TableCell className="text-right">{formatPercent(rateKomisi)}</TableCell>
                    </TableRow>
